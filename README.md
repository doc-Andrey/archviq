...
- `cognitive_test.html` — Stage 2 browser cognitive battery
...
The site keeps the free first calculation useful and routes users toward paid depth:

- Architecture snapshot — free
- Cognitive + GAP — $12
- Target questionnaire — $19
- Full Architecture Report — $39

The free profile demonstrates the model; the paid layers add measurement, comparison and interpretation depth.
