...
LABELS = {
    "RU": {
        ...
        "maturation": "Временной акцент развития",
    },
    "EN": {
        "resource": "Resource",
        "switching": "Switching",
        ...
        "maturation": "Developmental timing",
    },
}
...
TEXT = {
    "RU": {
        ...
        "maturation": {
            "high": "В общей временной конфигурации профиля больший вес имеют более поздние окна развития.",
    ...
    "EN": {
        ...
        "maturation": {
            "high": "Later developmental windows carry more weight in the profile's overall temporal configuration.",
